...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/divide_and_conquer: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/divide_and_conquer ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
# Subprojects
.build-subprojects:
	cd ../function_API && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../function_API && ${MAKE}  -f Makefile CONF=Release clean
