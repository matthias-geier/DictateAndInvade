...
LDLIBSOPTIONS=../function_API/dist/Release/GNU-Linux-x86/libfunction_API.so
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblua_framework.so: ${OBJECTFILES}
	...
	${LINK.c} -shared -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblua_framework.so -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/lua_framwork_lib.o: lua_framwork_lib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../function_API -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/lua_framwork_lib.o lua_framwork_lib.c

${OBJECTDIR}/lua_transform_array.o: lua_transform_array.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I../function_API -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/lua_transform_array.o lua_transform_array.c
